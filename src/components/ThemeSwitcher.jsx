...
const ThemeSwitcher = () => {
  ...
  return (
    <>
    <label className='themeSwitcherThree relative inline-flex cursor-pointer select-none items-center px-2'>
        <input
          type='checkbox'
          checked={darkMode}
          ...
          className='sr-only'
        />
        <div className='shadow-card flex h-6 w-16 items-center justify-center rounded-xl bg-blue-200 dark:bg-sky-700'>
          <span
          title='Light Mode'
            className={clsx("flex h-6 w-8 items-center justify-center rounded-xl",!darkMode ? 'bg-blue-700 text-yellow-500' : 'text-white')}
          >
            <svg
              width='16'
              height='16'
          ...
          <span
          title='Dark Mode'
            className={clsx("flex h-6 w-8 items-center justify-center rounded-xl",darkMode ? 'bg-blue-800 text-blue-950' : 'text-blue-500')}
          >
            <svg
              width='16'
              height='16'
